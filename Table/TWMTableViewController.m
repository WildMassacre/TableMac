...
- (id)init {
    ...
    if (self) {
        ...
        editingMode = NO;
        what2fixWindow = [[TWMWhatToFixWindowController alloc] initWithWindowNibName:@"WhatToFixWindow"];
...
- (IBAction)closeInputWeightWindow:(id)sdiender {
...
- (IBAction)openWhatToFixWindow:(id)sender {
    [what2fixWindow showWindow: self];
}
@end
